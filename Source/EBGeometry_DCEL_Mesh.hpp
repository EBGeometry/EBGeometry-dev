...
namespace EBGeometry::DCEL {
  ...
  */
  ...
  public:
    ...
    */
    ...
    /*!
      ...
      @param[in] a_mesh Other mesh
      @note Can use compiler-defined because Mesh does not allocate anything on its own.
    */
    EBGEOMETRY_GPU_HOST_DEVICE
    EBGEOMETRY_ALWAYS_INLINE
    Mesh(const Mesh& a_mesh) noexcept = default;
    ...
    */
    EBGEOMETRY_GPU_HOST_DEVICE
    EBGEOMETRY_ALWAYS_INLINE
    Mesh(Mesh&& a_mesh) noexcept = default;
    ...
    */
    ...
    EBGEOMETRY_ALWAYS_INLINE
    Mesh&
    operator=(const Mesh& a_mesh) noexcept = default;
    ...
    */
    ...
    EBGEOMETRY_ALWAYS_INLINE
    Mesh&
    operator=(Mesh&& a_mesh) noexcept = default;
    ...
    */
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    setSearchAlgorithm(SearchAlgorithm a_algorithm) noexcept;
    ...
    */
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    setInsideOutsideAlgorithm(Polygon2D::InsideOutsideAlgorithm a_algorithm) noexcept;
    ...
    */
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    reconcile(DCEL::VertexNormalWeight a_weight = DCEL::VertexNormalWeight::Angle) noexcept;
  ...
  protected:
    ...
    */
    SearchAlgorithm m_algorithm = SearchAlgorithm::Direct;

    /*!
      @brief Vertex list
    */
    Vertex<MetaData>* m_vertices = nullptr;

    /*!
      @brief Edge list
    */
    Edge<MetaData>* m_edges = nullptr;

    /*!
      @brief Face list
    */
    Face<MetaData>* m_faces = nullptr;
    ...
    */
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    reconcileVertices(VertexNormalWeight a_weight) noexcept;
...
#include "EBGeometry_DCEL_MeshImplem.hpp" // NOLINT
