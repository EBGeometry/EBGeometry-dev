...
namespace EBGeometry::DCEL {
  ...
  public:
    ...
    EBGEOMETRY_GPU_HOST_DEVICE
    EBGEOMETRY_ALWAYS_INLINE
    Edge(const Edge& a_otherEdge) noexcept = default;
    ...
    EBGEOMETRY_GPU_HOST_DEVICE
    EBGEOMETRY_ALWAYS_INLINE
    Edge(Edge&& a_otherEdge) noexcept = default;
    ...
    EBGEOMETRY_GPU_HOST_DEVICE
    EBGEOMETRY_ALWAYS_INLINE
    Edge(int a_vertex, int a_previousEdge, int a_pairEdge, int a_nextEdge, int a_face) noexcept;
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    setVertex(int a_vertex) noexcept;
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    setPreviousEdge(int a_previousEdge) noexcept;
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    setPairEdge(int a_pairEdge) noexcept;
    ...
    EBGEOMETRY_ALWAYS_INLINE
    void
    setNextEdge(int a_nextEdge) noexcept;
