...
namespace EBGeometry::DCEL {
  ...
  Mesh<MetaData>::Mesh(int               a_numVertices,
                       int               a_numEdges,
                       int               a_numFaces,
  ...
  EBGEOMETRY_ALWAYS_INLINE
  void
  Mesh<MetaData>::define(int               a_numVertices,
                         int               a_numEdges,
                         int               a_numFaces,
                         Vertex<MetaData>* a_vertices,
                         Edge<MetaData>*   a_edges,
  ...
  EBGEOMETRY_ALWAYS_INLINE
  void
  Mesh<MetaData>::setInsideOutsideAlgorithm(Polygon2D::InsideOutsideAlgorithm a_algorithm) noexcept
  {
  ...
  EBGEOMETRY_ALWAYS_INLINE
  void
  Mesh<MetaData>::reconcile(VertexNormalWeight a_weight) noexcept
  {
    this->reconcileFaces();
    this->reconcileEdges();
  ...
  EBGEOMETRY_ALWAYS_INLINE
  void
  Mesh<MetaData>::reconcileVertices(VertexNormalWeight a_weight) noexcept
  {
